...
6. **Inbox** (`/inbox`, 2026-09-19; TD-069 — the one place to work from): full width, a **view over
   ...
   **Built 2026-09-19 (TD-069 step 1), mail only**: the three sections and their order, the
   ...
   seconds without emptying the depths, which count what is unread *or* open. State rows are step
   2 and board items step 3; until they land the page's count is mail alone.
