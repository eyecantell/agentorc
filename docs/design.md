...
- **Everything answered for the person is told to the person.** A reply that carries a
  ...
  *who asked what, who answered, from where*. The page's group, row and count are the page half — **the group and the row built 2026-09-21** (§4.5a), the team header's count not yet. **Overrule** on such a row is a
