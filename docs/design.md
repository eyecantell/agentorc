...
| Focus header | **VS Code** — the **editor** button | the same button as the card's, from the person's `open_in:` (§5 *The person's own*; design 2026-09-21, TD-095 second pass, built 2026-09-21, PR #N-OI) — `none` removes it here too |
