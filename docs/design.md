...
- `doing` (2026-09-19, TD-074; decided by Paul): **one line, the session's own word for what it is
  ...
  round; **a team card's header shows its manager's line** (as built 2026-09-19; **reversed by Paul 2026-09-21**, TD-095, built the same day, PR #N-HDR: the line is on the manager's card, the first in the group, and the header stops repeating it — §4.5 *The card's anatomy*), which is the manager reporting on the team
...
state), projects, and the needs-you count across its members (from TD-095 on — design 2026-09-21, built 2026-09-21, PR #N-HDR — the header carries the team, the host / repo its sessions share, the counts by state, its marks and its controls, and **not** its manager's name, state or line, which are on the manager's card: §4.5 *The card's anatomy*) — the manager's card first, its
