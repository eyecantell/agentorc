...
**Priority:** Medium
**Added:** 2026-09-10
**Status:** Open — design landed (§4.8); step (1) merged 2026-09-10 (caller on every RPC, the `orchestrate` gate, `capabilities` with `ao new --grant` / `ao grant` / `ao revoke`); step (2) merged 2026-09-11 (the two channels, `ao progress` / `ao finding`, `ao new --lane`, the skill's declare rule); steps (3)–(5) pending
