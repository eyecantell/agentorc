...
**Priority:** Medium
**Added:** 2026-09-12
**Status:** Open — design written 2026-09-12 (§4.8, §4.5a, §9 invariant 11, §10, [ADR](decisions/2026-09-12-orchestrator-membership-prior-art.md)); **not approved to implement** — the §10 question is open and the go/no-go is Paul's (attention board, due 2026-09-13)
...
**Related:** design §4.8, §4.5a, §5, §9 invariants 11–12, §10 (2026-09-12); [ADR 2026-09-12](decisions/2026-09-12-orchestrator-membership-prior-art.md); TD-028 (the grant this builds on), TD-026.
