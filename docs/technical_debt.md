...
| TD-041 | §9 invariant 5 is convention, not a gate: nothing stops a controller acting on an interactive session | Medium | Open |
...
**Priority:** Medium
**Added:** 2026-09-13
**Status:** Open — found by the independent review of TD-036 step 6, while fact-checking a migration doc that told a person the invariant was enforced
