...
**Priority:** Medium
**Added:** 2026-09-13
**Status:** Open — design task, decided vocabulary in [ADR 2026-09-13](decisions/2026-09-13-org-teams-projects.md); sequenced after TD-036 (its `controllers` edge is what a team is built on); not to be coded before it is in design §4.5, §4.8 and §5
