...
**Priority:** Medium
**Added:** 2026-09-12
**Status:** Open — design written 2026-09-12 (§4.8, §4.5a, §9 invariant 11, §10, [ADR](decisions/2026-09-12-orchestrator-membership-prior-art.md)); **go given by Paul 2026-09-13**, implementation handed to session `orc-membership-design` in the six steps below, the UI step after the Herd → Team rename lands
