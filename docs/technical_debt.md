...
**Priority:** Medium
**Added:** 2026-09-13
**Status:** Open — the two agentorc briefs were made repeatable the same day (PR #N); the general rule is not enforced anywhere and the samscrape prompts in `~/.tdgrind/` are still per-run
