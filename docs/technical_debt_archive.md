...
**Resolved:** 2026-09-22 (PR #444) — design §4.9b *Seats with a trigger* (the record's `trigger`, the tick's `seat_due`), §4.5 (the card's count); the manager's fill rule on `seat_due.met_at` stays TD-098 step (2).
