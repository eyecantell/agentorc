...
**Resolved:** 2026-09-25 (TD-140 slice 2, this PR; slice 1 PR #578) — step 4, the last, built by TD-140; steps 0–3 as its status says.
...
**Resolved:** 2026-09-25 (TD-140 slice 2, this PR; slice 1 PR #578) — the Inbox's *Put on the board*: the button on FYI and trail rows, the form (`board_add.html`), `/api/person/board` with `action: add`; slice 1 the write-back's add. Design §4.5a *Inbox row: FYI*, §4.4.
