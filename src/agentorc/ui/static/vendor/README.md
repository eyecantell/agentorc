...
package publishes (jsdelivr, 2026-09-20). Replace a file only together with its row, and keep
...
| `addon-fit.js` | `@xterm/addon-fit` | 0.10.0 | MIT (`LICENSE-xterm.txt`) |
| `addon-webgl.js` | `@xterm/addon-webgl` | 0.18.0 (the release paired with xterm 5.5.0) | MIT (`LICENSE-xterm.txt`) |
